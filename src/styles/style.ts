...
export const Button = styled.button<IStyle>`
	width: 100%;
	max-width: 90vw;
	border: ${(props) => (props.highlight ? "1px solid rgb(38, 93, 151)" : " rgb(0, 127, 255) 3px solid;")};
	background-color: ${(props) => (props.highlight ? "rgb(0, 127, 255)" : "rgb(0, 30, 60)")};
	color: ${(props) => (props.highlight ? "rgb(0, 30, 60)" : "rgb(0, 127, 255)")};
	padding: 10px;
	border-radius: 5px;
	cursor: pointer;
	font-weight: bold;
